            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-8">
                <Button
                  ...
                  size="lg"
                  className="group relative bg-slate-950/80 hover:bg-slate-950/90 text-slate-100 border border-white/10 backdrop-blur-xl px-8 py-6 text-lg font-serif shadow-2xl transition-all duration-300 hover:shadow-primary/30 hover:border-primary/50"
                >
                  ...
                  <motion.div
                    className="absolute inset-0 rounded-lg bg-gradient-to-r from-primary/0 via-primary/20 to-primary/0 opacity-0 group-hover:opacity-100 blur-sm"
                    animate={{ x: [-200, 200] }}
                ...
                <Button
                  ...
                  size="lg"
                  variant="ghost"
                  className="text-slate-100 hover:text-white hover:bg-slate-950/60 backdrop-blur-sm px-8 py-6 text-lg border border-white/10 font-serif"
                >
